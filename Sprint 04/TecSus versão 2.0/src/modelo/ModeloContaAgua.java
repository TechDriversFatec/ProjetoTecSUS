...
public class ModeloContaAgua {

	private int ContaAguaRGI;
	private int ContaAguaNConta;
	private int ContaAguaGrupo;
	private String ContaAguaMesRef;
	private String ContaAguaTipoLigacao;
	private String ContaAguaTipoFaturamento;
	private int ContaAguaConsumo;
	private String ContaAguaDataLeituraAtual;
	private String ContaAguaLeituraAtual;
	private String ContaAguaDataLeituraAnterior;
	private String ContaAguaLeituraAnterior;
	private String ContaAguaObservacao;
	private String ContaAguaValorAgua;
	private String ContaAguaValorEsgoto;
	private String ContaAguaValorTotal;
	private String pesquisa;
	
	
	public int getContaAguaRGI() {
		return ContaAguaRGI;
	}
	public void setContaAguaRGI(int contaAguaRGI) {
		ContaAguaRGI = contaAguaRGI;
	}
	public int getContaAguaNConta() {
		return ContaAguaNConta;
	}
	public void setContaAguaNConta(int contaAguaNConta) {
		ContaAguaNConta = contaAguaNConta;
	}
	public int getContaAguaGrupo() {
		return ContaAguaGrupo;
	}
	public void setContaAguaGrupo(int contaAguaGrupo) {
	...
	public int getContaAguaConsumo() {
		return ContaAguaConsumo;
	}
	public void setContaAguaConsumo(int contaAguaConsumo) {
